...
### [**2.1 Multi-omics and molecular data resources**](docs/PennAITech_expert/4.1_Data_Multi-omics)
...
### [**2.2 Functional annotation and variant resources**](docs/PennAITech_expert/4.2_Data_FunctionalAnnotation)
...
### [**2.3 Risk factor and epidemiological data resources**](docs/PennAITech_expert/4.3_Data_RiskFactors)
